...
local assets =
{
    ...
    Asset("IMAGE", "images/uiimages/wardrobe_tool_slot.tex"),
    Asset("ATLAS", "images/uiimages/wardrobe_tool_slot.xml"),
    Asset("IMAGE", "images/uiimages/wardrobe_hat_slot.tex"),
    Asset("ATLAS", "images/uiimages/wardrobe_hat_slot.xml"),
    Asset("IMAGE", "images/uiimages/wardrobe_chest_slot.tex"),
    Asset("ATLAS", "images/uiimages/wardrobe_chest_slot.xml")
}
...
local function fn()
    ...
    inst:SetPhysicsRadiusOverride(.5) -- 0.8 会导致添加燃料被卡住。。。
...
return Prefab("mone_wardrobe", fn, assets, prefabs),
MakePlacer("mone_wardrobe_placer", "wardrobe", "wardrobe", "closed")
