...
local function OnPlayed(inst, musician)
    ...
    if musician:IsOnValidGround() then
        ...
        local rabbitkinghorn_chest = SpawnPrefab("mone_rabbitkinghorn_chest")
...
local function fn()
    ...
    inst.components.inventoryitem.imagename = "rabbitkinghorn"
    inst.components.inventoryitem.atalsname = "images/DLC/inventoryimages2_250801/inventoryimages2.xml"
...
return Prefab("mone_rabbitkinghorn", fn, assets, prefabs)
