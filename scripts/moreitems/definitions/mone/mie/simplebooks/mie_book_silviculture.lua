...
local data = {
    assets = { Asset("ANIM", "anim/books.zip"),Asset("ANIM", "anim/mie_books.zip"), },
    assets_fx = { Asset("ANIM", "anim/fx_books.zip"), },
    name = "mie_book_silviculture",
    tags = { "mie_book_silviculture" },
    animstate = { bank = "mie_books", build = "mie_books", animation = "mie_book_silviculture" }, -- 换个贴图吧？simplebook组件应该就是给烹饪书写的。。。但是换成烹饪指南的话。难搞哦。
    minimap = "mie_book_silviculture.tex",
    ...
    inventoryitem_fn = function(inst)
        inst.components.inventoryitem.imagename = "mie_book_silviculture";
        inst.components.inventoryitem.atlasname = "images/inventoryimages/mie_book_silviculture.xml";
