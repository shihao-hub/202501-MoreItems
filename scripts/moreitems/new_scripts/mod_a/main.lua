...
if getmetatable(_G) == nil then
    require("moreitems.new_scripts.mod_a.strict")
end
morel_G = {}
...
morel_RELATIVE_SRC_PATH = "moreitems.new_scripts/"
...
-- 通用
require("moreitems.new_scripts.mod_a.common_global")

-- 工具集模块
morel_Switch = require("moreitems.new_scripts.mod_a.module.switch_statement")
morel_TrueFalseHandler = require("moreitems.new_scripts.mod_a.module.true_false_handler")

-- Only for personal test, only is lua environment.
if morel_IS_LUA_DEBUG_MODE then
    -- 其他
    require("moreitems.new_scripts.mod_a.util.personal_json")
    -- 23/11/1 Lua for windows has a mass of valuable codes to learn !!!!!!
    morel_LfW_global = require("moreitems.new_scripts.mod_a.module.global")
    morel_LfW_list = require("moreitems.new_scripts.mod_a.module.list")
end
