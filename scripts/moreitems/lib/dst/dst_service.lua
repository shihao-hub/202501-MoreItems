...
--[[
添加新物品流程：
1. 定义 prefab 文件 -> prefab file path
2. modtuning.lua 创建配置项 -> config_data.config_item = xxx
3. enable_prefabs.lua 新增内容 -> AddPrefabFiles + env.modimport
4. language/mone/loc.lua 新增内容
5. modmain/init/init_tooltips 新增内容
6. recipes.lua 添加内容
