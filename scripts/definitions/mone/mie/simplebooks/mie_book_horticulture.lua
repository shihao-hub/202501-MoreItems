...
local data = {
    ...
    animstate = { bank = "mie_books", build = "mie_books", animation = "mie_book_horticulture" },
    minimap = "mie_book_horticulture.tex",
    inventoryitem_fn = function(inst)
        inst.components.inventoryitem.imagename = "mie_book_horticulture";
        inst.components.inventoryitem.atlasname = "images/inventoryimages/mie_book_horticulture.xml";
