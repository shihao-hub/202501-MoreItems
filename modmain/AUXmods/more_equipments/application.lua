...
local function recipes()
    ...
    if isDebug() then
        ...
        --Recipes[#Recipes + 1] = {
        --    name = "me_forginghammer", tech = TECH.SCIENCE_TWO, filters = { "MONE_MORE_ITEMS1" },
        --    ingredients = {
        ...
        --Recipes[#Recipes + 1] = {
        --    name = "me_blossomedwreath", tech = TECH.SCIENCE_TWO, filters = { "MONE_MORE_ITEMS1" },
        --    ingredients = {
    ...
    Recipes[#Recipes + 1] = {
        name = "me_resplendentnoxhelm", tech = TECH.SCIENCE_TWO, filters = { "MONE_MORE_ITEMS1" },
        ingredients = {
    ...
    Recipes[#Recipes + 1] = {
        name = "me_featheredwreath", tech = TECH.SCIENCE_TWO, filters = { "MONE_MORE_ITEMS1" },
        ingredients = {
    ...
    Recipes[#Recipes + 1] = {
        name = "me_clairvoyantcrown", tech = TECH.SCIENCE_TWO, filters = { "MONE_MORE_ITEMS1" },
        ingredients = {
    ...
    Recipes[#Recipes + 1] = {
        name = "me_spiralspear", tech = TECH.SCIENCE_TWO, filters = { "MONE_MORE_ITEMS1" },
        ingredients = {
    ...
    Recipes[#Recipes + 1] = {
        name = "me_pithpike", tech = TECH.SCIENCE_TWO, filters = { "MONE_MORE_ITEMS1" },
        ingredients = {
            Ingredient("twigs", 4), Ingredient("rope", 2), Ingredient("flint", 2),
            Ingredient("goldnugget", 2),
        },
    ...
    --Recipes[#Recipes + 1] = {
    --    name = "me_crystaltiara", tech = TECH.SCIENCE_TWO, filters = { "MONE_MORE_ITEMS1" },
    --    ingredients = {
...
-- hook associated contents? 我当时为什么取这个名字？
