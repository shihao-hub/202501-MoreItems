...
env.Assets = {
    ...
    Asset("IMAGE", "images/inventoryimages/mie_book_horticulture.tex"),
    Asset("ATLAS", "images/inventoryimages/mie_book_horticulture.xml"),

    Asset("IMAGE", "images/inventoryimages/mie_book_silviculture.tex"),    
    Asset("ATLAS", "images/inventoryimages/mie_book_silviculture.xml"),


    Asset("IMAGE", "images/inventoryimages/mone_beef_bell.tex"),
    Asset("ATLAS", "images/inventoryimages/mone_beef_bell.xml"),

    Asset("IMAGE", "images/inventoryimages/mone_beef_bell_linked.tex"),
    Asset("ATLAS", "images/inventoryimages/mone_beef_bell_linked.xml"),
    ...
    Asset("IMAGE", "images/DLC/inventoryimages2_250801/inventoryimages2.tex"),
    Asset("ATLAS", "images/DLC/inventoryimages2_250801/inventoryimages2.xml"),
